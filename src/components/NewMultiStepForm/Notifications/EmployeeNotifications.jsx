...
const fetchNotifications = async () => {
  ...
  try {
    ...
    let url = "";
    if (role === "admin") {
      url = `${BASE_URL}/api/admin/notifications?limit=20&page=1`;
      ...
      url = `${BASE_URL}/api/notifications/employee?employeeId=${employeeId}&limit=20&page=1`;
    }
    ...
    if (url) {
      ...
      // ✅ Handle both data formats: array directly or wrapped in notifications property
