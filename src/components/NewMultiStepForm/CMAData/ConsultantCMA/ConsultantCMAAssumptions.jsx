...
const ConsultantCMAAssumptions = ({
  formData = {},
  financialYearLabels = [],
  formatNumber,
  pdfType,
  ...
  orientation,
    ...
    const totalRevenueReceipts = formData?.computedData?.totalRevenueReceipts || 0;
    const receiveTotalExpense = formData?.computedData?.totalExpense || 0;
...
export default React.memo(ConsultantCMAAssumptions);
