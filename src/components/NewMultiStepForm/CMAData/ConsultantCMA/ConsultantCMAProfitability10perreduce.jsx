...
const ConsultantCMAProjectedProfitability = ({
  formData,
  formatNumber,
                ...
                <View style={[styles.table,]}>
                  ...
                  <View style={[stylesMOF.row, styles.tableRow, { border: 0 }]}>
                    ...
                    {labels.map((_, localIdx) => (
                      ...
                      >
                        {formatNumber(
                          value10reduceRevenueReceipt?.[globalIndex(localIdx)] ||
                          0
                        )}
                      </Text>
                    ))}
                  ...
                  >
                    ...
                    {labels.map((_, localIdx) => (
                      ...
                      >
                        {formatNumber(
                          newRevenueReceipt?.[globalIndex(localIdx)] || 0
                        )}
                      </Text>
                    ))}
                  </View>
                  ...
                  >
                    ...
                    {labels.map((_, localIdx) => (
                      ...
                      >
                        {formatNumber(
                          adjustedRevenueValues?.[globalIndex(localIdx)] || 0
                        )}
                      </Text>
                    ))}
                  </View>
...
export default React.memo(ConsultantCMAProjectedProfitability);
