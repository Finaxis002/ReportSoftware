    ...
    <div className="flex h-[100vh] bg-gray-50 dark:bg-gray-900 transition-colors duration-300 relative">
      ...
      <div className="app-content flex-1 overflow-auto">
        ...
        <div className="p-6">
          ...
          <div className="w-full bg-white dark:bg-gray-800 backdrop-blur-lg rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-xl mb-2 relative z-40">
          ...
          {/* Empty State */}
          {!isDataSelected && (
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center rounded-2xl bg-white dark:bg-gray-800 shadow border border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-xl font-medium text-gray-700 dark:text-gray-200 mb-2">No Report Selected</h3>
