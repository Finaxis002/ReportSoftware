...
// const StepperControl = ({  isUpdateMode = false,
//    handleUpdate, 
//    handleNext, 
//    handleBack, 
//    handleSave, 
...
//           className="bg-orange-500 text-white uppercase py-2 px-4 rounded-xl font-semibold cursor-pointer border-2 hover:bg-orange-700 transition duration-200 ease-in-out"
//         >
//           Update Report
//         </button>
//       )}
...
//         type="button"
//         onClick={handleSave}
//         className="bg-blue-500 text-white uppercase py-2 px-4 rounded-xl font-semibold cursor-pointer border-2 hover:bg-blue-700 transition duration-200 ease-in-out"
//       >
//         Save Data
//       </button>
//       )}

//       <button onClick={handleCreateNewFromExisting} className="btn btn-primary">
//           Create New Report from Existing
//       </button>

// {/* 
//       <button onClick={() => handleNextStep(stepData)}  
