  ...
  return (
    <PageWithFooter size="A4" style={styles.page}>
      ...
      <View style={styles.table}>
        ...
        <View style={[styles.tableRow , {borderTop: "1px solid #000", borderBottom: "1px solid #000"}]}>
          ...
          <Text
            style={[
              ...
              stylesCOP.textCenter,
              stylesCOP.boldText,
              { borderTop: 0, borderBottom: 0 , border:0},
            ]}
          >
            {totalQuantity}
          </Text>
...
export default React.memo(ConsultantProjectedSalaries);
