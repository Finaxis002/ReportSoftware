          ...
          <View>
            ...
            <View style={[styles.table, { borderRightWidth: 0 }]}>
             ...
             {/* conslusion */}
              ...
              {/* Projected Profitability Statement - Version 2+ */}
              {versionNum >= 2 && (
                <View
                  style={[
                    styles.tableRow,
              ...
              {/* Income Tax Calculation - Version 2+ */}
              {versionNum >= 2 && (
                <View
                  style={[
                    styles.tableRow,
              ...
              {/* Projected Cash Flow Statement - Version 3+ */}
              {versionNum >= 3 && (
                <View
                  style={[
                    styles.tableRow,
              ...
              {/* Projected Balance Sheet - Version 3+ */}
              {versionNum >= 3 && (
                <View
                  style={[
                    styles.tableRow,
              ...
              {/* Current Ratio Analysis - Version 3+ */}
              {versionNum >= 3 && (
                <View
                  style={[
                    styles.tableRow,
              ...
              {/* Debt Service Coverage Ratio - Version 4+ */}
              {versionNum >= 4 && (
                <View
                  style={[
                    styles.tableRow,
              ...
              {/* Break Even Point Analysis - Version 4+ */}
              {versionNum >= 4 && (
                <View
                  style={[
                    styles.tableRow,
...
export default React.memo(VariableIndex);
