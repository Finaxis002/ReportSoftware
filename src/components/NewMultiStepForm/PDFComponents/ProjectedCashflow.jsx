...
//       calculateInterestOnWorkingCapital(yearIndex); // Call function to get Interest on Working Capital
...
//       const interestOnWorkingCapitalValue =
//         calculateInterestOnWorkingCapital(index);
...
//       //   .reduce((sum, asset) => {
//       //     const assetValue =
//       //       typeof asset.years[index] === "number" ? asset.years[index] : 0;
...
//   const isInterestOnTermLoanZero = Array.from({
//     length: projectionYears,
//   }).every((_, index) => yearlyInterestLiabilities[index] === 0);
...
//     <Text style={[stylesCOP.serialNoCellDetail, { paddingVertical: "10px", fontWeight: "bold" }]}>A</Text>
//     <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, styleExpenses.bordernone, { paddingVertical: "10px", fontWeight: "bold" }]}>Sources</Text>
//     {Array.from({ length: projectionYears }).map((_, index) => (
//       <Text key={index} style={[stylesCOP.particularsCellsDetail, styleExpenses.fontSmall]}></Text>
//     ))}
//   </View>

//   {/* Net Profit before Interest & Taxes */}
//   <View style={styles.tableRow}>
//     <Text style={[stylesCOP.serialNoCellDetail, styleExpenses.sno]}>{getNextSourcesSerial()}</Text>
//     <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, styleExpenses.bordernone]}>Net Profit before Interest & Taxes</Text>
//     {financialYearLabels.map((_, index) => (
//       <Text key={index} style={[stylesCOP.particularsCellsDetail, styleExpenses.fontSmall]}>
//         {formatNumber(netProfitBeforeInterestAndTaxes[index] || 0)}
//       </Text>
//     ))}
//   </View>
...
//   <View style={styles.tableRow}>
//     <Text style={[stylesCOP.serialNoCellDetail, styleExpenses.sno]}>{getNextSourcesSerial()}</Text>
//     <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, styleExpenses.bordernone]}>Promoters’ Capital</Text>
//     {Array.from({ length: projectionYears }).map((_, index) => (
//       <Text key={index} style={[stylesCOP.particularsCellsDetail, styleExpenses.fontSmall]}>
//         {formatNumber(index === 0 ? formData.MeansOfFinance.totalPC || "-" : "0")}
//       </Text>
//     ))}
//   </View>
...
//     <View style={styles.tableRow}>
//       <Text style={[stylesCOP.serialNoCellDetail, styleExpenses.sno]}>{getNextSourcesSerial()}</Text>
//       <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, styleExpenses.bordernone]}>Bank Term Loan</Text>
//       {Array.from({ length: projectionYears }).map((_, index) => (
//         <Text key={index} style={[stylesCOP.particularsCellsDetail, styleExpenses.fontSmall]}>
//           {formatNumber(index === 0 ? formData?.MeansOfFinance?.termLoan?.termLoan || "-" : "0")}
//         </Text>
//       ))}
//     </View>
//   )}
...
//     <View style={styles.tableRow}>
//       <Text style={[stylesCOP.serialNoCellDetail, styleExpenses.sno]}>{getNextSourcesSerial()}</Text>
//       <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, styleExpenses.bordernone]}>Working Capital Loan</Text>
//       {Array.from({ length: projectionYears }).map((_, index) => (
//         <Text key={index} style={[stylesCOP.particularsCellsDetail, styleExpenses.fontSmall]}>
//           {formatNumber(index === 0 ? formData.MeansOfFinance?.workingCapital?.termLoan || "-" : "0")}
//         </Text>
//       ))}
//     </View>
//   )}

//   {/* Liabilities from More Details */}
//   {formData?.MoreDetails?.currentLiabilities
//     ?.filter((liabilities) => !liabilities.years.every((value) => Number(value) === 0))
//     .map((liabilities, idx) => (
...
//     <View style={styles.tableRow}>
//       <Text style={[stylesCOP.serialNoCellDetail, styleExpenses.sno]}>{getNextSourcesSerial()}</Text>
//       <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, styleExpenses.bordernone]}>Depreciation</Text>
//       {Array.from({ length: projectionYears }).map((_, index) => (
//         <Text key={index} style={[stylesCOP.particularsCellsDetail, styleExpenses.fontSmall]}>
...
//     <Text style={[stylesCOP.detailsCellDetail, styleExpenses.particularWidth, { paddingVertical: "8px", fontWeight: "bold", textAlign: "right" }]}>
//       Total
//     </Text>
