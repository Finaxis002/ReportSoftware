...
const Dashboard = () => {
    ...
    return (
        <div className="app-container">
            <MenuBar />
            {isSuccess && <div className="app-content">
                ...
                <div className="container">
                    ...
                    {/* <div className="row py-4 my-2 bg-lightBlue rounded">
                        <div className="col-md-3">
                            <ButtonCard cardColor="credentialing" />
                        </div>
                        <div className="col-md-3">
                            <ButtonCard cardColor="education" />
                        </div>
                        <div className="col-md-3">
                            <ButtonCard cardColor="wallet" />
                        </div>
                        <div className="col-md-3">
                            <ButtonCard cardColor="human-resources" />
                        </div>
                    </div> */}
                        ...
                        <div className="col">
                            ...
                            <div className="products-area-wrapper tableView">
                                <div className="products-header">
                                    ...
                                    <div className="product-cell category">Phone<button className="sort-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                    </button></div>
                                    <div className="product-cell status-cell">Status<button className="sort-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                    </button></div>
                                    <div className="product-cell sales">Rate<button className="sort-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" /></svg>
                                    </button></div>
                                ...
                                </div>
                                {
                                    ...
                                    (<div className="products-row" key={index}>
                                        ...
                                        <div className="product-cell image">
                                            <img src="https://png.pngtree.com/element_our/png_detail/20181227/report-vector-icon-png_295013.jpg" alt="product" />
                                            <span>{record.fields.name}</span>
                                        </div>
                                        <div className="product-cell category"><span className="cell-label">Category:</span>{record.fields.phone}</div>
                                        <div className="product-cell status-cell">
                                            <span className="cell-label">Status:</span>
                                            <span className="status active">Active</span>
                                        </div>
                                        <div className="product-cell sales"><span className="cell-label">Sales:</span>{record.fields.SimpleInterest + "%"}</div>
                                        <div className="product-cell stock"><span className="cell-label">Stock:</span>{convertToFriendlyDateTime(record.fields.CreatedAt).date + " | " + convertToFriendlyDateTime(record.fields.CreatedAt).time}</div>
                                        <div className="product-cell price"><span className="cell-label">Price:</span>${record.fields.TotalExpenditure}</div>
                                    </div>)
                                    )
                                }
