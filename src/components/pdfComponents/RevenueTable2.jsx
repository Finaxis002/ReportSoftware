            ...
            <View>
...

                {
                    entries.map((row, i) => {
                        return (
                            <>
                                <View style={styles.tableRowHeading} key={i}>
                                    <View style={styles.tableCellFull}>
                                        <Text>{row.key}.</Text>
                                    </View>
                                </View>
                                {
                                    row.value.map((subRow, j) => {
                                        return (
                                            <View style={styles.tableRowEven} key={i}>
                                                ...
                                                <View style={styles.tableCell}>
                                                    <Text>{subRow.particular}</Text>
                                                </View>
                                                {
                                                    subRow.years.map((val, j) => {
                                                        return (
